 ...
 * 
 */
@WebServiceClient(name = "lameduckService", targetNamespace = "http://lameduck.ws", wsdlLocation = "file:/D:/WebService/project/LameDuck/src/conf/xml-resources/web-services/lameduckServiceWSDL/wsdl/lameduck.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/D:/WebService/project/LameDuck/src/conf/xml-resources/web-services/lameduckServiceWSDL/wsdl/lameduck.wsdl");
